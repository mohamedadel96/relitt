  ...
  <section id="feeds-dashboard" class="d-flex mt-4">
    <div class="col-md-3 d-md-block d-none px-4">
      <div class="px-1">
        <user-card />
        <div>
          <exp-card :avg="expCard.avg_duration"  :diving="expCard.avg_duration_diving" :scuba="expCard.avg_duration_scuba" :measure="'min'" class="mt-4" />
          <exp-card :avg="expCard.max_depth" :diving='expCard.max_depth_diving' :scuba='expCard.max_depth_scuba' :measure="'m'" class="mt-4" />
          <exp-card :avg="expCard.dive_count" :diving='expCard.dive_count_diving' :scuba='expCard.dive_count_scuba' :measure="'dives'" class="mt-4" />
